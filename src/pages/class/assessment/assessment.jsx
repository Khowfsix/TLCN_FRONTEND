	...
	useEffect(() => {
		if (localStorage.getItem(`testing`) == false) {
			...
			setLectureContent({
				...
				content: `<p><b>Quantum mechanics, a fundamental theory in physics, revolutionized our understanding of the universe at the smallest scales. This Assessment delves into the intriguing world of quantum phenomena, covering the principles of superposition, entanglement, and wave-particle duality.</b></p>
				...
				<p>This Assessment aims to provide a comprehensive overview, inviting both enthusiasts and students of physics to dive into the mesmerizing realm of quantum mechanics.</p>
				`,
			});
		}
	}, []);
